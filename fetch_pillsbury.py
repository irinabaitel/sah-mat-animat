"""
fetch_pillsbury.py — Ia puzzle-uri pillsburysMate de pe Lichess API si actualizeaza pagina85.html

Utilizare:
    python fetch_pillsbury.py
...
HTML_FILE     = os.path.join(os.path.dirname(__file__), 'pagina85.html')
...
def validate_puzzle(raw: dict) -> dict | None:
    try:
        ...
        last_move = test.peek()
        piece = test.piece_at(last_move.to_square)
