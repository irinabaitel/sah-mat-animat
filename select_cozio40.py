...
candidates = json.load(open('data/cozio_candidates.json', encoding='utf-8'))
...
with open('data/cozio_top40.json', 'w', encoding='utf-8') as f:
    json.dump(selected, f, ensure_ascii=False, indent=2)
print("Salvat in data/cozio_top40.json")
