"""Fetch arabianMate puzzles from Lichess API and save to arabian_puzzles.json."""
...
with open('arabian_puzzles.json', 'w', encoding='utf-8') as f:
    json.dump(dedup, f, indent=2, ensure_ascii=False)
print('Salvat arabian_puzzles.json')
